...
DOIS_FILE = "bad_dois.json"
DB_DIR = "plos_dbs/"
DB_FILE_PREFIX = DB_DIR + "bad_db_"
N = 799 # number of papers to process.
...
# tot, proc, refs, ratio, l, cm, er, bt = multi_validate("final_dbs/final_db_", (0, c-1))
